...
<html lang="en">
      <head>
                             <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8117878186151066"
                    ...
                    <div class="alert alert-success col-sm-8">
                           ...
                           <tr>
                                ...
                                <td><strong>
                                    ...
                                    if ($data['status'] == 'verifikasi_berkas_kecamatan') : 
                                        echo "Verifikasi Berkas Kecamatan";
                                        elseif ($data['status'] == 'verifikasi_disdukcapil') : 
                                            ...
                                            elseif ($data['status'] == 'berkas_kurang_lengkap') :
                                                ...
                                                elseif ($data['status'] == 'verifikasi_kecamatan') :
                                                    echo "Berkas Lengkap";
                        ...
                        <div class="checkout-wrap my-4">
                            <ul class="checkout-bar  my-4">
                                ...
                                <?php elseif ($data['status'] == 'verifikasi_kecamatan') : ?>
                                    <li class="visited first">Verifikasi Berkas<br>Kecamatan</li>                                    
                                    <li class="previous visited">Proses Berkas di<br>Disdukcapil</li>                                   
                   ...
                   <div class="col-lg-13">
                        ...
                        <div class="info-wrap">
                            <div class="row" style="color: white;">
                              ...
                              <meta name="google-adsense-account" content="ca-pub-8117878186151066">
