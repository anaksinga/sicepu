<header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="container-fluid d-flex align-items-center">
        ...
        <div class="logo mr-auto">
            <h1>
                <a href="<?= base_url(); ?>"> <img src="<?= base_url() ?>/assets/img/sicepu.png" style="width: 50px; height: 40px; margin-top: -6px;"></a>
            </h1>
            ...
            <ul>
                ...
                ?>
                    ...
                    <li><a href="#pelayanan">Pelayanan</a></li>
                     <li><a href="https://docs.google.com/forms/d/1GpuMr0fY6GaAstPjXcWxZdPpBFdJpRATmr6GT94M6kY/viewform?edit_requested=true">Survey Kepuasan Masyarakat(SKM)</a></li>
                        ...
                        <a href="#" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            foreach ($data1 as $r1) {
                                ...
                                if (mysqli_num_rows($ceknotif) === 0) {
                                    if (!empty($r1['terakhir_diperpanjang']) or $r1['terakhir_diperpanjang'] != '0000-00-00') {
