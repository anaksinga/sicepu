        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Data Status</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_SESSION['pesan']) && $_SESSION['pesan'] <> '') {
                                        if ($_SESSION['pesan'] == "Status Sudah Ada !") {
                                    ?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody style="background-color: azure">
                                                <?php
                                                $data = $koneksi->query("SELECT * FROM status_nikah ORDER BY status_nikah ASC");
                                                foreach ($data as $row) {
                                                ?>
                                                    <tr align="center">
                                                        <td width="5%"><?= $no++; ?></td>
                                                        <td align="left"><?= $row['status_nikah'] ?></td>
                                                        <td width="10%">
                                                            <button id="edit" data-id="<?= encryptor('encrypt', $row['id_status']); ?>" class="btn bg-gradient-success btn-sm" title="Edit"><i class="fa fa-edit"></i></button>
                                                            <a href="hapus?id=<?= encryptor('encrypt', $row['id_status']); ?>" data-id="<?= $row['status_nikah'] ?>" class="btn bg-gradient-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                ...
                <form method="post" action="simpan">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="status_nikah" class="col-sm-6 col-form-label">Status</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="status_nikah" id="status_nikah" required>
                            </div>
                        </div>
