...
$data = $koneksi->query("SELECT * FROM peraturan_iumk WHERE id_peraturan = '$id'");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Dasar Hukum Rekomendasi Nikah</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item">Dasar Hukum Rekomendasi Nikah</li>
                            ...
                            <div class="card card-primary">
                                ...
                                <form class="form-horizontal" method="POST" action="">
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('admin/dasar-hukum-iumk') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
