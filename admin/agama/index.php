                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_SESSION['pesan']) && $_SESSION['pesan'] <> '') {
                                        if ($_SESSION['pesan'] == "Agama Usaha Sudah Ada !") {
                                    ?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody style="background-color: azure">
                                                <?php
                                                $data = $koneksi->query("SELECT * FROM agama ORDER BY agama ASC");
                                                foreach ($data as $row) {
                                                ?>
                                                    <tr align="center">
                                                        <td width="5%"><?= $no++; ?></td>
                                                        ...
                                                        <td width="10%">
                                                            <button id="edit" data-id="<?= encryptor('encrypt', $row['id_agama']); ?>" class="btn bg-gradient-success btn-sm" title="Edit"><i class="fa fa-edit"></i></button>
                                                            <a href="hapus?id=<?= encryptor('encrypt', $row['id_agama']); ?>" data-id="<?= $row['agama'] ?>" class="btn bg-gradient-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
