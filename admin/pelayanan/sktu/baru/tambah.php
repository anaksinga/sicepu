        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Tambah Data Surat Rekomendasi Nikah</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active">Pelayanan</li>
                                <li class="breadcrumb-item active">Surat Rekomendasi Nikah</li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class=" card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Form Tambah Surat Rekomendasi Nikah</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <div class="card-body" style="background-color: azure;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="nama_pemohon" id="nama_pemohon" style="width: 100%;" class="form-control select2"  required>
                                                    <option value=""></option>
                                                    <?php
