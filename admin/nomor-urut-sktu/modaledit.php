...
<div class="form-group">
    <label for="no_urut" class="col-sm-4 col-form-label">Nomor Urut Surat Pengantar</label>
    <div class="col-sm-12">
        <input type="text" class="form-control" name="nomor_urut" id="nomor_urut" value="<?= $row['nomor_urut'] ?>" minlength="9" maxlength="9" required>
