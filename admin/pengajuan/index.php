                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_SESSION['pesan']) && $_SESSION['pesan'] <> '') {
                                        if ($_SESSION['pesan'] == "Nama Pengajuan Sudah Ada !") {
                                    ?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody style="background-color: azure">
                                                <?php
                                                $data = $koneksi->query("SELECT * FROM pengajuan ORDER BY pengajuan ASC");
                                                foreach ($data as $row) {
                                                ?>
                                                    <tr align="center">
                                                        <td width="5%"><?= $no++; ?></td>
                                                        <td align="left"><?= $row['pengajuan'] ?></td>
                                                        <td width="10%">
                                                            <button id="edit" data-id="<?= encryptor('encrypt', $row['id_pengajuan']); ?>" class="btn bg-gradient-success btn-sm" title="Edit"><i class="fa fa-edit"></i></button>
                                                            <a href="hapus?id=<?= encryptor('encrypt', $row['id_pengajuan']); ?>" data-id="<?= $row['pengajuan'] ?>" class="btn bg-gradient-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                ...
                <form method="post" action="simpan">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="pengajuan" id="pengajuan" required>
                            </div>
                        </div>
