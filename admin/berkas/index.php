...
<body class="hold-transition sidebar-mini sidebar-collapse">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Data berkas kembali</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_SESSION['pesan']) && $_SESSION['pesan'] <> '') {
                                        if ($_SESSION['pesan'] == "Data Berkas Sudah Ada !") {
                                    ?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody style="background-color: azure">
                                                <?php
                                                $data = $koneksi->query("SELECT * FROM berkas ORDER BY berkas ASC");
                                                foreach ($data as $row) {
                                                ?>
                                                    <tr align="center">
                                                        <td width="5%"><?= $no++; ?></td>
                                                        <td align="left"><?= $row['berkas'] ?></td>
                                                        <td width="10%">
                                                            <button id="edit" data-id="<?= encryptor('encrypt', $row['id_berkas']); ?>" class="btn bg-gradient-success btn-sm" title="Edit"><i class="fa fa-edit"></i></button>
                                                            <a href="hapus?id=<?= encryptor('encrypt', $row['id_berkas']); ?>" data-id="<?= $row['berkas'] ?>" class="btn bg-gradient-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                ...
                <form method="post" action="simpan">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="berkas" id="berkas" required>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit Data Berkas/h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
