         ...
         <div class="row">
            ...
            <!--<div class="col-lg-3 col-6">-->
             ...
             <!-- <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('admin/pelayanan/sktu/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>-->
            <!-- ./col -->
            ...
            <!-- IUMK -->
            <div class="col-lg-30 col-6 align=center">
              <!-- small box -->
              <div class="small-box bg-primary">
                <div class="inner">
                  <h3><?= $iumk['jml']; ?></h3>
                ...
                <a href="<?= base_url('admin/pelayanan/rekomendasi-nikah/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-30 col-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('admin/pelayanan/surat-pengantar/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
           ...
           <!-- <div class="col-lg-3 col-6">-->
             ...
             <!-- <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('admin/pelayanan/rpp/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>-->
            <!-- ./col -->
            ...
            <!--<div class="col-lg-3 col-6">-->
              ...
              <!--<div class="small-box bg-primary">
                ...
                <a href="<?= base_url('admin/pelayanan/legalisasi-imb/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>-->
            <!-- ./col -->
           ...
           <!-- <div class="col-lg-3 col-6">-->
              ...
              <!--<div class="small-box bg-primary">
                ...
                <a href="<?= base_url('admin/pelayanan/legalisasi-proposal/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>-->
            <!-- ./col -->
            ...
            <!--<div class="col-lg-3 col-6">-->
             ...
             <!-- <div class="small-box bg-primary">
                ...
                <a href="<?= base_url('admin/pelayanan/legalisasi-izin-tower/') ?>" class="small-box-footer">Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>-->
            <!-- ./col -->
          ...
          <!--  <div class="col-md-4">
           ...
           <!--</div>-->
            ...
            <!--<div class="col-md-4">
              <div class="card card-purple">
                <div class="card-header">
                  <h3 class="card-title">Status Proses Surat Rekomendasi Nikah</h3>
           ...
           <!-- </div>-->
            ...
            <div class="card-body card-tools d-flex justify-content-center">
              <div class="card card-purple">
                <div class="card-header">
                  <h3 class="card-title">Status Proses Surat Pengantar</h3>
                  ...
                  <canvas id="ahliwaris" style="min-height: 500px; height: 500px; max-height: 500px; max-width: 100%;"></canvas>
                </div>
                <!-- /.card-body -->
              </div>
              <!-- /.card -->
